...
const BDWeek8 = () => (
    ...
    <section id="two">
        <div class="inner">
            <header class="major">
                <h2>Unit 8,9: Collaborative Discussion 2 - Comparing Compliance Laws</h2>
            </header>
            ...
            <h4>Initial Post</h4>
            <p>By Abiodun Maborukoje - Monday, 17 July 2023, 6:30 PM</p>
            ...
            <h4>Peer Review</h4>
            <p>By Simon Egli - Wednesday, 19 July 2023, 10:11 AM </p>
            <p>Hi Mabos, Thank you for your insightful post and the concise comparison between the General Data Protection Regulation (GDPR) and the Nigeria Data Protection Act (NDPA) regarding securing personal data rule. The content is well-structured and effectively highlights the similarities and differences between the two regulations. The discussion is focused and provides valuable insights into the respective requirements.</p>
            <p><strong>Specific Comments:</strong></p>
            <p>1. While the article briefly mentions the need for pseudonymisation and encryption of personal data under the GDPR, it would be helpful to provide further explanation on these concepts. Elaborating on how these techniques contribute to data security and their significance in protecting personal data would enhance the discussion, as done by Bolognini and Bistolfi (2017).</p>
            <p>2. The extraterritorial reach of the GDPR is mentioned briefly, but it would be helpful to highlight the implications of this aspect. Exploring the impact on organisations outside the EU that process the personal data of EU residents would provide a broader perspective on the practical challenges and compliance requirements.</p>
            <hr/>
            <p>By Hamid Abdul - Wednesday, 19 July 2023, 8:04 PM </p>
            <p>Hi Abiodun, Thank you for your insightful post. I appreciate your concise and clear explanation of the similarities and differences between the General Data Protection Regulation (GDPR) and the Nigeria Data Protection Act (NDPA). I have come across some additional differences online that I would like to share:</p>
            <p>&bull; Scope and Applicability: The GDPR has extraterritorial applicability, meaning it extends to organisations outside the European Union (EU) if they process personal data of EU residents. On the other hand, the Nigeria Data Protection Act primarily applies to data processing activities within Nigeria or by Nigerian entities (One Trust, 2021).</p>
            <p>&bull; Legal Bases for Processing: While both regulations include consent as a legal basis for data processing, the GDPR provides specific legal bases such as contractual necessity and legitimate interests. The Nigeria Data Protection Act recognises other lawful grounds for data processing, such as the performance of a contract or compliance with legal obligations (One Trust, 2020).</p>
            <p>&bull; Penalties and Sanctions: Non-compliance with the GDPR can result in significant fines, reaching up to 4% of a company's global annual turnover or &euro;20 million, whichever is higher. In contrast, the Nigeria Data Protection Act specifies fines, sanctions, or even imprisonment, depending on the nature and severity of the offence (One Trust guidance, 2021).</p>
             <hr/>
            <h4>Summary Post:</h4>
            <p>By Abiodun Maborukoje - Friday, 21 July 2023, 8:52 AM</p>
