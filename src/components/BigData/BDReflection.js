...
const BDReflection = () => (
    ...
    <div id="main">
			...
			<div class="inner">
				...
				<p>As we progressed to Unit 11, our team's focus shifted towards implementing the proposed database design and documenting the executive summary. In this final project, I took on the responsibility of populating the database with the dataset, which proved to be an immensely valuable experience. This task required applying various data extraction, exploration, cleaning, and modelling techniques that I had learned throughout the module. By doing so in a real-world context, I gained a deeper understanding of the practical significance and challenges of these techniques. 
				In response to the feedback received from the initial project, we recognized the importance of finding a dataset that reflects a real-world practical approach. The dataset closely resemble the type of data the application will encounter in its actual usage. This enabled us to conduct more realistic and meaningful tests during the development process. The final project, compared to the initial proposal, demonstrated substantial progress and maturity. We successfully transformed the conceptual database design into a functional application by populating it with real-world data. 
				</p>
